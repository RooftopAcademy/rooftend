import { ApiOperation, ApiProperty, ApiResponse, ApiTags } from '@nestjs/swagger';/* eslint-disable prettier/prettier */
import { 
...
export default class PaymentMethodsController {
    ...
    @ApiResponse({
        ...
        async find(@Param('id') id : number, @Res(({ passthrough: true })) response) : Promise<PaymentMethod> {
